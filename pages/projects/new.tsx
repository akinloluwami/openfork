...
const AddNewProject = () => {
  ...
  return (
    ...
    <Box>
      ...
      <Text fontSize="15px">Please follow the steps to create and publish your project</Text>
    </Box>
    ...
    <Flex my="3%" gap="15px" className="wrapper" justify="space-between">
      <Box w="350px">
        {/* project name  */}
      <Flex gap={4} p="20px" rounded="lg" w="full"  justify="center" bg="gray.900" my="20px" align="center">
      <SiGithub />
   ...
   <Flex gap={2} align="inherit" >
      ...
      <Circle bg={`${githubURL?"green.500":"gray.900"}`} m="0" p="10px" />
      <Box w="7px" flexShrink={"0"} h="35px" bg={`${githubURL?"green.500":"gray.900"}`}></Box>
      </Flex>
      <Text>Select Repository</Text>
    </Flex>
   <Flex gap={2} align="inherit" >
      <Flex gap="0" m="0" direction="column" align={"center"}>
      <Circle bg={`${githubURL && projectName && tagline && description?"green.500":"gray.900"}`} m="0" p="10px" />
      <Box w="7px" flexShrink={"0"} h="35px" bg={`${githubURL && projectName && tagline && description?"green.500":"gray.900"}`}></Box>
      </Flex>
      <Text>Project Info</Text>
    </Flex>
   <Flex gap={2} align="inherit" >
      <Flex gap="0" m="0" direction="column" align={"center"}>
      <Circle bg={`${githubURL && projectName && tagline && description && selectedTags.length > 0?"green.500":"gray.900"}`} m="0" p="10px" />
      <Box w="7px" flexShrink={"0"} h="35px" bg={`${githubURL && projectName && tagline && description && selectedTags.length > 0?"green.500":"gray.900"}`}></Box>
      </Flex>
   ...
   <Flex gap={2} align="inherit" >
      <Flex gap="0" m="0" direction="column" align={"center"}>
      <Circle bg={`${githubURL && projectName && tagline && description && selectedTags.length > 0?"green.500":"gray.900"}`} m="0" p="10px" />
      <Box w="7px" opacity={0} flexShrink={"0"} h="35px" bg={`${githubURL && projectName && tagline && description && selectedTags.length > 0?"green.500":"gray.900"}`}></Box>
      </Flex>
   ...
   <Flex gap={2} align="center">
    ...
    {/* about */}
    <Box>
      <Text fontWeight="bold" my="25px">Project Details</Text>
      <Flex gap={3} my={4} align="center">
      <Icon as={SiGithub} />
        <Text fontSize="14px" fontWeight="bold" color="blue.600">{githubURL}</Text>
      </Flex>

            <Flex gap={3} align="center">
        <Icon as={SiChainlink} />
        <Text fontSize="14px" fontWeight="bold" color="blue.600">{websiteURL}</Text>
      </Flex>
      <Box>
